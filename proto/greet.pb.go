...
var file_proto_greet_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x08, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x32, 0xdc, 0x02, 0x0a, 0x0b,
	0x47, 0x72, 0x65, 0x65, 0x74, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12, 0x40, 0x0a, 0x08, 0x53,
...
var file_proto_greet_proto_depIdxs = []int32{
	0, // 0: greet_service.GreetServer.SayHello:input_type -> greet_service.NoParam
	3, // 1: greet_service.GreetServer.SayHelloServerStreaming:input_type -> greet_service.NamesList
	1, // 2: greet_service.GreetServer.SayHelloClientStreaming:input_type -> greet_service.HelloRequest
	1, // 3: greet_service.GreetServer.SayHelloBidirectionalStreaming:input_type -> greet_service.HelloRequest
	2, // 4: greet_service.GreetServer.SayHello:output_type -> greet_service.HelloResponse
	2, // 5: greet_service.GreetServer.SayHelloServerStreaming:output_type -> greet_service.HelloResponse
	4, // 6: greet_service.GreetServer.SayHelloClientStreaming:output_type -> greet_service.MessagesList
	2, // 7: greet_service.GreetServer.SayHelloBidirectionalStreaming:output_type -> greet_service.HelloResponse
